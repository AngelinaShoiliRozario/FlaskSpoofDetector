...
while True:
    ...
    if prev_frame is None: 
        ...
        if ret:
            text = check_face(frame.copy())
            if text:
                cv2.putText(frame, f'MATCH! {y}', (20, 450), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
            else:
                cv2.putText(frame, f'NO MATCH!  {y}', (20, 450), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 3)
